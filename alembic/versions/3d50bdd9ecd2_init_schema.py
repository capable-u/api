...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["import_job_id"],
            ["import_jobs.id"],
            name=op.f("fk_transactions_import_job_id_import_jobs"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_transactions")),
    )
    op.create_index(
        op.f("ix_transactions_booking_date"),
        "transactions",
        ["booking_date"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_transactions_direction"), "transactions", ["direction"], unique=False
    )
    op.create_index(
        op.f("ix_transactions_duplicate_status"),
        "transactions",
        ["duplicate_status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_transactions_import_job_id"),
        "transactions",
        ["import_job_id"],
        unique=False,
    )
